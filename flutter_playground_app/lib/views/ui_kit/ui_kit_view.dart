...
import 'package:flutter_playground/views/ui_kit/color_scheme_example.dart';
import 'package:flutter_playground/views/ui_kit/text_theme_example.dart';
...
@RoutePage(name: 'UiKit')
class UiKitView extends ConsumerStatefulWidget {
  const UiKitView({super.key});

  @override
  ConsumerState<UiKitView> createState() => _CustomUIKitViewState();
}

class _CustomUIKitViewState extends ConsumerState<UiKitView> {
